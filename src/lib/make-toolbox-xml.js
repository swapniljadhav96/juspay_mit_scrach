...
const bakeCake = function (isInitialSetup, isStage, targetId, colors) {
    ...
    <category
        ...
        secondaryColour="${colors.tertiary}">
        textColor="${textColor}"> 
        <block type="bake_cake_ingredient1"></block>
        <block type="bake_cake_ingredient2"></block>
        <!-- Add more blocks for different cake ingredients -->
    </category>
    `;
};
...
const makeToolboxXML = function (isInitialSetup, isStage = true, targetId, categoriesXML = [],
    ...
    const bakeCakeXML = moveCategory("bakeCake") || bakeCake(isInitialSetup, isStage, targetId, colors);
